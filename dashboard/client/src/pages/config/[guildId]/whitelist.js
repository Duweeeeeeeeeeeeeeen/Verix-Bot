                ...
                <div className="v-stack animate slide-up">
                    <EmbedMessageManager
                        ...
                        slugs={[
                            ...
                            { key: 'dm_submitted', label: t('whitelist.design.dm_submitted'), description: t('whitelist.design.dm_submitted_desc'), variables: ['user', 'guild'], group: t('whitelist.design.group_dms'), groupIcon: CheckCircle2, module: 'whitelist' },
                            { key: 'dm_text_pass', label: t('whitelist.design.dm_text_pass'), description: t('whitelist.design.dm_text_pass_desc'), variables: ['user', 'guild'], group: t('whitelist.design.group_dms'), groupIcon: CheckCircle2, module: 'whitelist' },
                            { key: 'dm_accepted', label: t('whitelist.msg_accepted'), description: t('whitelist.msg_accepted_desc') || 'DM sent when an application is approved.', variables: ['user'], group: t('whitelist.design.group_dms'), groupIcon: CheckCircle2, module: 'whitelist' },
                            { key: 'dm_rejected', label: t('whitelist.msg_rejected'), description: t('whitelist.msg_rejected_desc') || 'DM sent when an application is rejected.', variables: ['user', 'reason'], group: t('whitelist.design.group_dms'), groupIcon: XCircle, module: 'whitelist' },
                            { key: 'staff_received', label: t('whitelist.design.staff_received'), description: t('whitelist.design.staff_received_desc'), variables: ['user_name', 'user_id', 'channel', 'app_id'], group: t('whitelist.design.group_staff_logs'), groupIcon: FileText, module: 'whitelist' },
                            { key: 'staff_accepted', label: t('whitelist.design.staff_accepted'), description: t('whitelist.design.staff_accepted_desc'), variables: ['user', 'staff', 'app_id'], group: t('whitelist.design.group_staff_logs'), groupIcon: FileText, module: 'whitelist' },
                            { key: 'staff_rejected', label: t('whitelist.design.staff_rejected'), description: t('whitelist.design.staff_rejected_desc'), variables: ['user', 'staff', 'app_id', 'reason'], group: t('whitelist.design.group_staff_logs'), groupIcon: FileText, module: 'whitelist' },
                            
                            // Background Module
                            { key: 'panel', label: t('background.msg_panel') || 'Background Panel', description: t('background.msg_panel_desc') || 'Main message for background submissions.', variables: ['guild'], group: t('background.design.group_panel'), groupIcon: Layout, module: 'background' },
                            { key: 'dm_received', label: t('background.design.dm_received'), description: t('background.design.dm_received_desc'), variables: ['user', 'guild'], group: t('background.design.group_dms'), groupIcon: CheckCircle2, module: 'background' },
                            { key: 'dm_accepted', label: t('background.msg_accepted') || 'Background Accepted', description: t('background.msg_accepted_desc') || 'Sent by DM to the approved user.', variables: ['user'], group: t('background.design.group_dms'), groupIcon: CheckCircle2, module: 'background' },
                            { key: 'dm_rejected', label: t('background.msg_rejected') || 'Background Rejected', description: t('background.msg_rejected_desc') || 'Sent by DM to the rejected user.', variables: ['user', 'reason'], group: t('background.design.group_dms'), groupIcon: XCircle, module: 'background' },
                            { key: 'staff_received', label: t('background.design.staff_received'), description: t('background.design.staff_received_desc'), variables: ['userId', 'bg_link', 'bg_desc', 'app_id'], group: t('background.design.group_staff_logs'), groupIcon: FileText, module: 'background' },
                            { key: 'staff_accepted', label: t('background.design.staff_accepted'), description: t('background.design.staff_accepted_desc'), variables: ['user', 'staff', 'app_id'], group: t('background.design.group_staff_logs'), groupIcon: FileText, module: 'background' },
                            { key: 'staff_rejected', label: t('background.design.staff_rejected'), description: t('background.design.staff_rejected_desc'), variables: ['user', 'staff', 'app_id', 'reason'], group: t('background.design.group_staff_logs'), groupIcon: FileText, module: 'background' }
                        ]}
                    />
